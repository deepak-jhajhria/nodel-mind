    ...
    return (
        <div id='whyChooseUs' className="mt-10 sm:mt-16 md:mt-[100px] lg:mt-[150px] relative">
            <div className="container flex flex-col items-center justify-center overflow-hidden">
                        ...
                        className='w-full'>
                        {
                            Items.map((items, index) => (
                                <SwiperSlide key={index}>
                                    <div data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease" className={`border border-[#EEDDFB] rounded-xl p-[18px] sm:max-w-[377px] 2xl:max-w-full w-full min-h-[180px] sm:min-h-[208px] overflow-auto`}>
                                        <span data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease" className='border-[7px] text-sm font-bold font-Outfit flex items-center justify-center rounded-full bg-gradient-to-tr from-[#A854E9] to-[#4F91FC] bg-clip-text text-transparent border-[#F4EAFC] h-9 w-9'>{items.id}</span>
                                        <p data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease" className='mt-3 text-xl font-normal font-Outfit text-[#131200]'>{items.title}</p>
                                        <p data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease" className='mt-1 pTag'>{items.para}</p>
                                    </div>
                                </SwiperSlide>
                            ))
                        }
                ...
                <Image data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease" className='w-full h-auto mt-6 rounded-2xl sm:rounded-3xl max-sm:aspect-[4/3]' src="/assets/images/webp/chooseusimg.webp" alt='image' width={1140} height={527} priority />
            </div>
