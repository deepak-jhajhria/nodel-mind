        ...
        <div id="services" className="mt-10 sm:mt-16 md:mt-[100px] lg:mt-[150px]">
            <div id="contact" className="container grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-[64px]">
                <div className="col-span-1">
                    ...
                    <p data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease" className="mt-2 sm:mt-3 pTag md:mt-4 max-w-[409px] text-center md:text-start leading-6 mx-auto md:mx-0">Feel free to contact us any time . We will get back to you as soon as we can! </p>
                    <form ref={form} className="mt-4 sm:mt-5" action="submit" onSubmit={sendEmail}>
                        <div className="flex items-center w-full">
                            <div className="flex flex-col w-1/2 mr-[6]">
                                ...
                                <input data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease" className="border input border-[#D0D0CC] rounded-lg outline-none pTag py-[10px] sm:py-3 px-2" type="text" name="Name" id="firstName" required />
                            </div>
                            <div className="flex flex-col w-1/2 ml-[6px]">
                                ...
                                <input data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease" className="border input border-[#D0D0CC] rounded-lg outline-none pTag py-[10px] sm:py-3 px-2" type="text" name="Name" id="lastName" required />
                            </div>
                        </div>
                        <div className="flex flex-col w-full mt-3 sm:mt-4">
                            ...
                            <input data-aos="fade-up" data-aos-duration="500" data-aos-easing="ease" className="border input border-[#D0D0CC] rounded-lg outline-none pTag py-[10px] sm:py-3 px-2" type="text" name="Name" id="email" required />
                        </div>
                        <div className="flex flex-col w-full mt-3 sm:mt-4">
