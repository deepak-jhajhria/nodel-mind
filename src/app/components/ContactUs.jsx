...
const ContactUs = () => {
    return (
        <div className="mt-10 sm:mt-16 md:mt-[100px] lg:mt-[150px]">
            <div className="container grid grid-cols-1 lg:grid-cols-2 gap-[64px]">
                ...
                <div>
                    <Image className="rounded-xl" src="/assets/images/png/contactusimg.png" alt="image" width={598} height={572} />
                </div>
            </div>
        </div>
    )
